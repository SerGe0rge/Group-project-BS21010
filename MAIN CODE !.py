# -*- coding: utf-8 -*-
"""
Created on Sat Dec 19 15:45:45 2020
...
def file_save_unblind():
    ...
    if mb == 'yes':
       ...
       with open(filesave, 'w') as wf:
               ...
               wf.write('Treatment list: ' + treatment_list) #saves the unblind timetable under filename specified before
               wf.write('\n')
               wf.write('Control list: ' + control_list)
       messagebox.showinfo('Save', 'Thank you! Your file has been saved') #confirms the file has been saved
